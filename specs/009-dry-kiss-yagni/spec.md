...
<<<<<<< HEAD
- **NFR-001**: Aucune régression sur les 68 tests Playwright déclarés (66 exécutables + 2 skip LDAP/OIDC).
=======
- **NFR-001**: Aucune régression sur les 68 tests Playwright documentés.
...
<<<<<<< HEAD
- **SC-007**: Les tests Playwright restent verts. **68 tests déclarés / 66 exécutables à relancer dans l'environnement cible avant release.**
=======
- **SC-007**: Les tests Playwright restent verts. **68 tests à relancer dans l'environnement cible avant release.**
>>>>>>> ecc3f8c942cba7bf8a68ccdea106117d1721b958
