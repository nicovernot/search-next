...
<<<<<<< HEAD
- **SC-005**: Les 68 tests Playwright déclarés (66 exécutables + 2 skip LDAP/OIDC) restent verts après tous les renommages.
=======
- **SC-005**: Les 68 tests Playwright documentés restent verts après tous les renommages.
