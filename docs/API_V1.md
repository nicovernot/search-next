...
**Dernière vérification** : 2026-09-03 — endpoints publics `/api/v1` exposés par `search_api_solr/app/api/v1/` (vérifiés contre `search.py`, `suggest.py`, `facets.py`, `permissions.py`, `main.py`), y compris le paramètre `core` (feature `016-solr-multi-core-support`).
