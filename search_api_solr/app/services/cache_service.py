...
class CacheService:
    ...
    async def get_search_cache(self, search_params: dict[str, Any]) -> dict[str, Any] | None:
    ...
    async def get_suggest_cache(self, query: str) -> dict[str, Any] | None:
    ...
    async def get_permissions_cache(self, urls: str, ip: str | None = None) -> dict[str, Any] | None:
    ...
    async def set_permissions_cache(self, urls: str, permissions: dict[str, Any], ip: str | None = None) -> bool:
